...
const descriptions: Record<WomanStage, Record<LanguageCode, string>> = {
  menstruation: {
    es: "Para adolescentes y adultas en periodo fértil. Calendario de flujo lunar, fertilidad y autocuidado de cólicos.",
    mi: "Kati Laka dukiara, mairin pain laka nani sa. Kati siska, mairin biliki mairin pain siska hilp daukanka.",
  ...
  menopause: {
    ...
    mi: "Mairin almuk mairin kurak pyua ra dukiara sa. Lapta kani kaisa, dusa bara kupia pain karkara dukiara sa.",
    ma: "Para adultas mayores transitando al cese fértil. Control de bochornos, salud de huesos y consejos para vivir en plenitud y sabiduría.",
  },
};
  ...
  return (
    <View style={styles.box}>
      <View style={styles.titleRow}>
        <Ionicons name="sparkles" size={15} color={Colors.rose} />
        <Text style={styles.title}>Orientación de la etapa:</Text>
      </View>
      <Text style={styles.body}>{descriptions[stage][language]}</Text>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  body: { color: "#57534E", fontSize: 12, lineHeight: 18 },
});
